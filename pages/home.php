		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 project">
					<!--<h3 id="counter">0</h3>-->
					<h4>Nós ajudamos você </h4>
					<p>Precisa de algo rápido? você pode contar com a gente para arrumar tudo pra você. </p>
				</div>
				<div class="col-md-4 project">
					<!--<h3 id="counter1">0</h3>-->
					<h4>Tudo à um clique de distância</h4>
					<p>Passos simpes para achar o melhor modo de transportar seus pertences.</p>
				</div>
				<div class="col-md-4 project">
					<!--<h3 id="counter2" style="margin-left: 20px;">0</h3>-->
					<h4 style="margin-left: 20px;">Escolha seu preço</h4>
					<p>Quanto vale seu frete? aqui você pode escolher o valor que deseja pagar. </p>
				</div>
			</div>
		</div>
		<div class='searchbox'>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 cBusiness">
					...
					<h4>Você pode acessar nosso site de qualquer lugar, seu smartphone, tablet, notebook...</h4>
		...
		<div class="container">
			<div class="row team">
				<div class="col-md-4 b1">
						...
						<p>Você pode conseguir um valor que esteja no seu orçamento</p>
						<!--<ul>
				...
				<div class="col-md-4">
						...
						<p>Sem mais dúvidas na hora de contratar alguém.</p>
				...
				<div class="col-md-4 b3">
						...
						<h4>Ana Eduarda</h4>
						<p>Tudo é feito no conforto do seu lar.</p>
				...
				<div class="row about">
					<div class="col-md-6">
						...
						<img class="pic1Ab" src="images/picAbout/aboutP1.png">
							...
							<p>Transportadores confiáveis, avaliados pelos nossos clientes. Você ainda pode converssar com eles pelo nosso site</p>
						</div>
					</div>
					<div class="col-md-6">
						<div class="about2">
				...
				<div class="row about">
					<div class="col-md-6">
						...
						<img class="pic1Ab" src="<?php echo BASE; ?>images/picAbout/aboutP3.png">
							<h3>Marcos Silva</h3>
							<p> Quando pesquisei pela primeira vez um transporte, achei os preços muito elevados, aqui eu consegui fazer o transporte do meu carro, pagando um valor muito menor e com uma transportadora muito boa.</p>
						</div>
					</div>
					<div class="col-md-6">
						<div class="about2">
						<img class="pic2Ab" src="<?php echo BASE; ?>images/picAbout/aboutP1.png">
							<h3>Sarah Ribeiro</h3>
							<p>Site muito bom! Procurei por muito tempo, antes de conhecer o site, um bom transportador para fazer minha mudança, e não achava nenhum. Quando encontrava não sentia nenhuma segurança. Agora faça tudo aqui. </p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="line3">
			<div class="container">
				...
				<div class="row Ama">
					...
					<p>Escolha uma de nossas categorias e anuncie já seu frete.
					</div>
				</div>
			</div>
		</div>          
			...
			<!-- filter_block -->
				<div id="options" class="col-md-12" style="text-align: center;">	
					<ul id="filter" class="option-set" data-option-key="filter">
						...
						<li><a href="#filter" data-option-value=".mudancas">Mudanças</a></li>
						<li><a href="#filter" data-option-value=".artigos">Artigos Domésticos</a></li>
						<li><a href="#filter" data-option-value=".cargas">Cargas</a></li>
						<li><a href="#filter" data-option-value=".veiculosBarcos">Veículos e Barcos</a></li>
			...
			<div class="portfolio_block columns3   pretty" data-animated="fadeIn">	
					...
					<div class="element col-sm-4  gall artigos">
						...
						<div class="view project_descr center">
							<h3><a href="<?php echo BASE; ?>/html/subcategoria/artigos_domesticos.html">Móveis</a></h3>
							<ul>
					...
					<div class="element col-sm-4  gall artigos">
						...
						<div class="view project_descr center">
							<h3><a href="<?php echo BASE; ?>/html/subcategoria/artigos_domesticos.html">Eletrodomésticos</a></h3>
							<ul>
								<li><i class="fa fa-eye"></i>369</li>
								<li><a  class="heart" href="#"><i class="fa-heart-o"></i>86</a></li>
							</ul>
					...
					<div class="element col-sm-4  gall artigos">
						...
						<div class="view project_descr center">
							<h3><a href="<?php echo BASE; ?>/html/subcategoria/artigos_domesticos.html">Frágeis</a></h3>
							<ul>
								<li><i class="fa fa-eye"></i>369</li>
								<li><a  class="heart" href="#"><i class="fa-heart-o"></i>86</a></li>
							</ul>
